              ...
              <div className="grid md:grid-cols-2">
                ...
                >
                  ...
                  <div className="mt-6 flex flex-wrap gap-4">
                    ...
                    <a
                      href="https://www.instagram.com/royal_decorzz_?igsh=djh6MHg4bTFrMzQ3"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-white/90 hover:text-white transition-colors"
                      aria-label="Follow on Instagram"
                    >
                      <Instagram className="w-5 h-5 shrink-0" style={{ color: '#E4405F' }} />
                      <span>Instagram</span>
                    </a>
                  </div>
                  <div className="mt-4 space-y-2 text-white/90">
      ...
      <footer className="px-6 md:px-10 py-8 border-t border-white/10 mt-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-sm">
            ...
            <a className="inline-flex items-center gap-1.5 text-white/60 hover:text-white transition-colors" href="https://wa.me/916383503223" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
              <MessageCircle className="w-4 h-4" style={{ color: '#25D366' }} /> WhatsApp
            </a>
            <a className="inline-flex items-center gap-1.5 text-white/60 hover:text-white transition-colors" href="https://instagram.com/royaldecorzz" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
